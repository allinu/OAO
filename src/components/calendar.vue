<template>
    <div class="w-full grid grid-cols-3 bg-gray-100 p-5 rounded-xl">
        <div class="col-span-1 grid grid-cols-2 grid-rows-4 gap-4 px-5">
            <div class="card col-span-2 row-span-2 bg-green-700 dark:bg-green-200 p-10 pt-20 relative rounded-xl">
            ...
            <div class="card col-span-1 row-span-1 bg-black text-white rounded-xl p-5">
                <div class="text-4xl">{{ current_time }}</div>
                <div>{{ today_date }}</div>
            </div>
            <div class="card col-span-1 row-span-1 bg-yellow-200 rounded-xl p-5">
                <div class="text-4xl">{{ todo_count }}</div>
                <div>{{ todo_disc }}</div>
            </div>
            <div class="card col-span-2 row-span-1 bg-purple-200 rounded-xl p-5">
        ...
        <div class="col-span-2 p-5 pt-10">
            <table class="w-full rounded-xl p-5">
                ...
                <tbody class="items-center">
                    <tr v-for="task in tasks" :key="task.id" class=" row-span-1 grid grid-cols-12 text-center hover:bg-indigo-100 p-5 rounded-xl duration-300">
                        ...
                        <td class="col-span-1">
                            <div class="w-full rounded-full bg-yellow-300">
                                {{ task.task_tag }}
                            </div>
                        </td>
                        <td class="col-span-1 text-red-500">{{ task.task_flag }}</td>
                        <td class="col-span-2 px-2">
                            <div class="w-full rounded-full bg-green-200">
                                {{ task.task_location }}
                            </div>
                        </td>
                        <td class="col-span-1">
            ...
            tasks: [
                {
                    ...
                    task_img: "http://m.imeitou.com/uploads/allimg/2019022710/b4jgfd5plcg.jpg",
                    task_tag: "闹钟",
                    task_flag: "",
                    task_location: "办公室",
                    task_edit: "",
